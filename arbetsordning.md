# ARBETSORDNING FÖR DATATEKNOLOGERNA VID ÅBO AKADEMI RF
...
Register förs över föreningens hedersmedlemmar, seniormedlemmar, ordinarie medlemmar, gulnäbbsmedlemmar, utbytesmedlemmar,
...
verksamhet inom föreningen och adresser.
...
- utföra arbetsplikt enligt styrelsens anvisningar
- hitta på en uppfinning, jäynä eller ge en gåva i teknologanda till styrelsen
- delta i åtminstone tre (3) evenemang
- få ett godkänt vitsord i kursen Introduktion till informationsteknologi
- delta i ett (1) föreningsmöte
- slutföra Eldprowet
...
**§ 4 Övriga mötesärenden**

Utöver de ärenden, som enligt stadgarna behandlas på föreningsmöten, ska följande ärenden
anförtros dessa möten:

- uppdragande av huvudlinjerna för föreningens verksamhet
- beslut om större anskaffningar
- av styrelsen eller föregående föreningsmöte hänskjutna ärenden
...
Medlem får ej delta i behandlingen av en fråga, där hen i saken har väsentligt större intresse
än andra medlemmar eller om hens enskilda fördel strider mot föreningens. Styrelsemedlem
...
föreningens stadgar är fastställt om ändring av arbetsordning.
...
till nästa möte och justeras på detta. Protokollet undertecknas av mötessekreteraren,
mötesordföranden samt de två (2) valda protokolljusterarna.

## KAPITEL IV – STYRELSEN

**§ 8 Sammansättning**

Styrelsen består av ordförande, viceordförande, sekreterare, skattmästare, programchef, källarmästare, näbbansvarig, företagsförhållandeansvarig och kommunikationsansvarig.
...
Styrelseordföranden åligger att:

- sammankalla och leda förenings- och styrelsemöten
...
- bistå styrelseordföranden och då denna har förhinder träda i hens ställe
- leda organiserandet av en exkursion på vår- eller höstterminen
...
- leda organiserandet av föreningens företagsmässa
...
- sammanställa verksamhetsberättelsen till vårmötet
...
- skriva bokslutet tillsammans med viceordföranden
...
Företagsförhållandeansvarige åligger att:

- sköta om kontakten med företag
- upprätthålla och sälja sponspaket
- beställa halarna
- delta i organiserandet av föreningens företagsmässa

**§ 19 Kommunikationsansvarig**

Kommunikationsansvarige åligger att:
...
Höstmötet tillsätter Datörer för följande verksamhetsår. Datörerna består av en (1) kernel
...
**§ 22 DaTes Idrottsklubb**

**Sammansättning**

Höstmötet tillsätter minst två (2) D.I.K ansvariga samt en (1) idrottsminister (Ordförande) för följande verksamhetsår.
...
Vårmötet tillsätter ett CommodoreuZkott för följande årsfest. CommodoreuZkottet består av en (1) marskalk (Ordförande), en (1) vice-marskalk, en (1) till två (2) nachspiel- och sillfrukostansvariga, en (1) designansvarig samt en (1) sponsoransvarig. Vårmötet kan tillsätta en (1) till tre (3) övriga medlemmar vid behov. CommodoreuZkottet är funktionärer för det år som årsfesten hålls.
...
Höstmötet tillsätter ett Programutskott för följande verksamhetsår. Programutskottet består av
programchefen (Ordförande) samt två (2) till sex (6) programmerare (Medlemmar).
...
3. **Fotografianter**
    ...
    **Uppgift**
    ...
    Fotografianterna fotograferar föreningens aktiviteter samt skannar bilder till
...
4. **Idrottsminister**
    ...
    **Uppgift**
    ...
    motionsverksamhet för ämnesföreningens medlemmar. Idrottsministern ska också
    söka in till den nuvarande aktuella sportklubben för DaTe.
...
8. **Vaalkommittén**
    ...
    **Sammansättning**
    ...
    Höstmötet tillsätter en vaalkommitté för följande verksamhetsår. Vaalkommittén består av två (2)
    ordinarie medlemmar.
...
10. **Albins Software & Services**
    ...
    **Sammansättning**
    ...
    Höstmötet tillsätter en (1) eller två (2) Albins Software & Services mekaniker (Medlemmar) för följande verksamhetsår.
...
## KAPITEL VIII – REPRESENTATION

**§ 28 Representanter**

När en årsfestinbjudan av annan förening tas emot ska styrelsen först besluta om det finns ett behov av att DaTe är representerad på årsfesten.
Ifall styrelsen bestämmer att föreningen borde representeras på årsfesten, är det i första hand någon/några ur styrelsen som ska representera föreningen.
I de fall där styrelsen inte har möjlighet att representera föreningen kan en förfrågan skickas till föreningens funktionärer.

Ifall ingen funktionär har möjlighet att representera föreningen, och styrelsen anser att föreningen borde representeras på årsfesten, kan styrelsen besluta om att skicka ut en förfrågan till föreningens samtliga medlemmar där tydliga riktlinjer för möjlig ersättning skickats med.

**§ 29 Ersättning för årsfestgåva**
